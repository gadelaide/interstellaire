execute if score @s p_cooldown matches ..5 run scoreboard players set @s p_cooldown 5
...
execute as @s if entity @s[level=5..] at @s run function is:powers/19sparkling_ray/init

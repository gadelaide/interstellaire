execute if score @s p_cooldown matches ..100 run scoreboard players set @s p_cooldown 100
...
execute as @s if entity @s[level=25..] at @s run function is:powers/4ice_trap/init
